...
export function AsfdkDeployView() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'assistant', 
      content: 'I am your ASFDK-Deploy pathway guide. Let\'s get your governed agent into production.' 
    }
  ]);
  ...
  return (
    ...
    >
      <details style={{ marginTop: '1rem' }}>
        ...
        <pre style={{ whiteSpace: 'pre-wrap', background: '#05070d', padding: '1rem', borderRadius: 12, color: '#f8fafc', fontSize: '0.85rem', marginTop: '0.5rem' }}>{ASFDK_DEPLOY_AGENT_PROMPT}</pre>
      </details>
    </PlaygroundShell>
  );
}
